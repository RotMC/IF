...
mvn install:install-file -Dfile=cache/patched_1.14.4.jar -DgroupId=io.papermc -DartifactId=paper -Dversion=1.14.4-R0.1-SNAPSHOT -Dpackaging=jar -DgeneratePom=true
```
...
mvn install:install-file -Dfile=cache/patched_1.15.2.jar -DgroupId=io.papermc -DartifactId=paper -Dversion=1.15.2-R0.1-SNAPSHOT -Dpackaging=jar -DgeneratePom=true
```
