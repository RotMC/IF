package com.github.stefvanschie.inventoryframework.nms.v1_20_4.util;
...
public final class TextHolderUtil {
    ...
    private static Component toComponent(@NotNull ComponentHolder holder) {
        return Objects.requireNonNull(Component.Serializer.fromJson(holder.asJson(), CraftRegistry.getMinecraftRegistry()));
    }
}
