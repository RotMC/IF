package com.github.stefvanschie.inventoryframework.nms.v1_21_10;

import com.github.stefvanschie.inventoryframework.abstraction.EnchantingTableInventory;
import com.github.stefvanschie.inventoryframework.adventuresupport.TextHolder;
import com.github.stefvanschie.inventoryframework.nms.v1_21_10.util.TextHolderUtil;
        ...
        public CraftEnchantmentView getBukkitView() {
            if (bukkitEntity == null) {
                try {
                    ...
                    org.bukkit.inventory.EnchantingInventory inventory = new CraftInventoryEnchanting(container) {
                        @NotNull
                        @Contract(pure = true)
                        @Override
